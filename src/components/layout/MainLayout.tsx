...
export function MainLayout() {
  ...
  const navItems = [
    ...
    { path: '/usage', label: t('nav.usage', { defaultValue: 'Usage' }), icon: sidebarIcons.usage },
    { path: '/api-keys', label: t('nav.api_keys', { defaultValue: 'API Keys' }), icon: sidebarIcons.apiKeys },
